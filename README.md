...
They provide a suite of operations that "tabularized", which is a concept similar
to vectoraization and broadcasting in other table-oriented libraries like numpy,
pandas, and xarray. The same way these libraries get rid of the need for for
...
You can find the Tapr documentation at
